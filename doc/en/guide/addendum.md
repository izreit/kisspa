...
`presetColors` provides Tailwind-inspired color palettes.
...
The palettes mirror Tailwind CSS v3.4.4. Each palette contains tones `50` through `950` with hex values:
